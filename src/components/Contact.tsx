        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Calle laureles #20, Colonia el Romeral, C.P. 76915
              <br />
              Corregidora, Quéretaro
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              <a href="tel:+52720 469 0624" className="hover:text-blue-600">
                720 469 0624
              </a>
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              <a
                href="mailto:contacto@autotop.mx"
